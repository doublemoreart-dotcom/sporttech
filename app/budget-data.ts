...
export const metrics = [
  {
    ...
    detailTitle: "政策總額怎麼讀",
    detail:
      "46 億元是 2022-2026 運動X科技跨部會政策總盤，重點是辨識它分散在哪些部會、年度科目與地方分案，而不是把它當成單一機關的一筆支出。",
    flow: ["政策核定", "年度預算", "分案/採購", "驗收/成果"],
    checks: [
      "先確認行政院或科技會報核定的是政策總額、計畫期程與主責部會。",
      "再拆年度中央政府總預算、科技預算與運動部/國科會科目，避免重複計算。",
      "最後比對地方核定、採購決標、驗收紀錄與成果報告，確認是否真的落地。",
    ],
  ...
  },
  {
    ...
    detailTitle: "科研線索怎麼追",
    detail:
      "科研預算常出現在國科會、GRB、學研計畫與國家隊支援成果中。它通常不會直接長成民眾看到的場館系統，而是先成為模型、感測、分析工具或訓練支援。",
    flow: ["研究計畫", "學研團隊", "模型/設備", "國訓/場域"],
    checks: [
      "用 GRB 查計畫名稱、主持人、補助機關、執行期間與成果摘要。",
      "比對國科會新聞、補助公告與學校研究成果，確認是否屬同一條計畫線。",
      "確認成果是否進入國訓中心、單項協會、地方場域或商品化應用。",
    ],
  ...
  },
  {
    ...
    detail:
      "地方場域通常是中央補助、地方配合款與委外廠商共同形成。看到案數時，要繼續追核定金額、決標金額、驗收狀態、維運費與實際使用量。",
    flow: ["中央核定", "地方配合款", "採購/委辦", "維運使用"],
    checks: [
      "先查地方府會預算書、議會質詢與中央補助核定，分開看中央款與地方款。",
      "再查政府採購決標公告、契約廠商與驗收資訊，確認金額是否已形成契約。",
  ...
  },
  {
    ...
    detail:
      "協會在運動科技中常是應用端、場域端或選手資料的合作窗口。要判斷是否直接承接預算，需看補助名單、委辦契約、採購得標與成果報告，而不是只看協會是否出現在活動或新聞中。",
    flow: ["補助名單", "委辦契約", "合作露出", "實際承接"],
    checks: [
      "查協會是否列為受補助者、委辦承攬者或採購得標單位。",
      "區分新聞中的合作露出、提供選手資料、提供賽事場域與實際經費承接。",
