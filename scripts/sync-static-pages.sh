...
require_file "${outputs_root}/assets/sporttech-menu-icon.png"
...
require_file "${public_root}/sporttech-menu-icon.png"
...
require_file "${pages_root}/assets/sporttech-menu-icon.png"
...
grep -q 'sporttech-menu-icon.png' "${pages_html}"
